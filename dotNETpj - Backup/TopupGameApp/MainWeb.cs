        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string strCommand = "Select PRODUCT.ProdName as Name, PRODUCT.gems as Gems, PRODUCT.credits as Credits," +
                    " PRODUCT.ProdPrice as Price, CART_ITEMS.quantity as Quantity, CART_ITEMS.quantity*PRODUCT.ProdPrice as subTotal " +
                    "From PRODUCT inner join CART_ITEMS on CART_ITEMS.ProdID = PRODUCT.ProdID " +
                    "inner join CART on CART.CartID = CART_ITEMS.CartID " +
                    "inner join ACCOUNT on ACCOUNT.usn = " + "'" + UserAccount.CurrentUsername + "'";
                SqlConnection myConnection = new SqlConnection(strConnectString);
                myConnection.Open();
