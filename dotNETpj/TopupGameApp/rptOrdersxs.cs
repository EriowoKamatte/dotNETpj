...
namespace TopupGameApp {
    ...
    public class rptOrdersxs : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TopupGameApp.rptOrdersxs.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptOrdersxs : Component, ICachedReport {
        
        public CachedrptOrdersxs() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptOrdersxs rpt = new rptOrdersxs();
            rpt.Site = this.Site;
            return rpt;
        }
