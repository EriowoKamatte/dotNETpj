    ...
    public partial class AccInfo : Form
    {
        ...
        private void btnDelAcc_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToBoolean(myCommand.Parameters["@Check"].Value.ToString()))
            {
                ...
                string strDeleteAccount = "DELETE FROM ACCOUNT WHERE usn = " + "'" + UserAccount.CurrentUsername + "'";
                myCommand.Parameters.AddWithValue("@Username", txtName.Text);
                myCommand.ExecuteNonQuery();
                ClearInfo();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToBoolean(myCommand.Parameters["@Check"].Value.ToString()))
            {
                ...
                string strDeleteAccount = "UPDATE ACCOUNT SET pwd = " + "'" + txtNewPassword.Text + "'" 
                    + " WHERE usn= " + "'" + txtName.Text + "'";   
                SqlCommand my2ndCommand = new SqlCommand(strDeleteAccount, myConnection);
